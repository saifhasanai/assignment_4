...
//         {['fullName', 'email', 'age', 'gender', 'feedback'].map((field, idx) => (
//           <input key={idx} name={field} onChange={handleChange} placeholder={field} className="w-full p-2 border" />
//         ))}
      ...
      <div className="bg-white p-8 rounded-xl shadow-md w-full max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <input name="gender" placeholder="Gender" onChange={handleChange} required className="p-2 border rounded w-full" />
          </div>
